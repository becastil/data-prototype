...
/**
 * Animated sidebar/menu using variants.
 * Adapted to use framer-motion already in this repo.
 */
const AnimatedVariantsMenu: React.FC = () => {
...
export default AnimatedVariantsMenu;
...
const Navigation = () => (
  <motion.ul style={list} variants={navVariants as Variants}>
    {[0, 1, 2, 3, 4].map((i) => (
      <MenuItem i={i} key={i} />
    ))}
  </motion.ul>
